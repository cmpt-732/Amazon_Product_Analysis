...
def main(inputs):
    ...
    fig3 = px.pie(sorteddfPur2, values = 'Num_purchases', names = 'product_name', title = 'Top 100 Customer Preferences in Office Products Category', height = 1500, width = 2500)
    fig3.show() 
...
""" #Products with hightes weighted average:
    ...
    fig4 = px.scatter(WeightedDf1, x = 'final_weighted_avg', y = 'product_name' ,title = 'Office Products to recommend',height=1300, width=1000)
