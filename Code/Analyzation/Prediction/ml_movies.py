...
def main():
    ...
    reviews_path = '/Users/hersh/Documents/BigDataLab/Project/Movies_and_TV.json'
    ...
    meta_path = '/Users/hersh/Documents/BigDataLab/Project/meta_Movies_and_TV.json'
    ...
    pd_merged.to_csv("ml_movies.csv")
