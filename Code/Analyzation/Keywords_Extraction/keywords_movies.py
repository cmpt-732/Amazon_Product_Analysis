...
def main():
            ...
            office_reviews = spark.read.schema(reviews_schema).json("/Users/jarvis/Amazon_Product_Analysis/Dataset/Movies_and_TV_5.json.gz").select("asin","reviewText","overall").cache()
    ...
    types.StructField("keywords", StringType(), False)])))
            ...
            office_good_reviews.select("key_words").limit(500).toPandas().to_json("/Users/jarvis/Amazon_Product_Analysis/Results/movies_keywords.json")
