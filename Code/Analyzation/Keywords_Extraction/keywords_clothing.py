...
def main():
            ...
            office_reviews = spark.read.schema(reviews_schema).json("/Users/hersh/Documents/BigDataLab/Project/Clothing_Shoes_and_Jewelry_5.json").select("asin","reviewText","overall").cache()
    ...
    types.StructField("keywords", StringType(), False)])))
            ...
            office_good_reviews.select("key_words").limit(500).toPandas().to_json("clothing_keywords.json")
